...
def _verify_openssl_version(lib):
    """ We understand that this library will not support this version of OpenSSL
    going forward, skipping this to unblock adoption.
    https://t.corp.amazon.com/issues/V330935407
    """
    return
    if (
        ...
        warnings.warn(
            "\n********************************************************************\n"
            "OpenSSL version 1.0.2 is being deprecated at Amazon. Here is a wiki  \n"
            "with instructions on upgrading your version set \n"
            "https://w.amazon.com/bin/view/AWSCryptography/AWSCryptoTools/C3P/SoftwareUpgrade/OpensslDefaultUpgrade\n"
            "********************************************************************",
